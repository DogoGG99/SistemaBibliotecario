 ...
 * @author dulce
 */
public class frmPedirLibro extends javax.swing.JFrame {

    /**
     * Creates new form frmPedirLibro
     */
    public frmPedirLibro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnRegistrar.setFont(new java.awt.Font("Arial Narrow", 1, 14)); // NOI18N
        ...
        jLabel2.setText("Al registrar la accion, se estara prestando un libro al usuario.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPedirLibro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPedirLibro().setVisible(true);
            }
        });
    }
